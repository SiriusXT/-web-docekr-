...
class IndexHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        for i in range(0,1):
            ...
            divImages = divImages + "<th><input style='display:none' type='checkbox' name='imagesid' value=" + ss[i][0]+":"+ss[i][1] + " '></th>"
        ...
        divContains+="<th><input type='radio' style='display:none' name='id' value=" +  "CONTAINERID"  + " '></th>"
        ...
        divRun+="<tr>"
        divRun+="<th><input type='radio' style='display:none' name='id' value=" +  "CONTAINERID"  + " '></th>"
